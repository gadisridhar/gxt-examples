 ...
 */
package com.msco.mil.client.com.sencha.gxt.explorer.client.draw;
...
public class LogoExample implements IsWidget, EntryPoint {
  ...
  public Widget asWidget() {
    ...
    Gradient senchaGrad1 = new Gradient("grad1", 100);
    senchaGrad1.addStop(0, new Color("#AACE36"));
    senchaGrad1.addStop(100, new Color("#2FA042"));

    Gradient senchaGrad2 = new Gradient("grad2", 21);
    ...
    Gradient senchaGrad3 = new Gradient("grad3", 55);
    ...
    Gradient blackBlue = new Gradient("bb", 90);
