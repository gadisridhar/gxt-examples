 ...
 */
package com.msco.mil.client.com.sencha.gxt.desktopapp.client.filemanager;
...
import com.msco.mil.client.com.sencha.gxt.desktopapp.client.filemanager.images.Images;
import com.msco.mil.client.com.sencha.gxt.desktopapp.client.persistence.FileModel;
import com.msco.mil.client.com.sencha.gxt.desktopapp.client.persistence.FileModel.FileType;
import com.msco.mil.client.com.sencha.gxt.desktopapp.client.persistence.FileModelProperties;
...
public class FileManagerViewImpl implements FileManagerView, HideHandler {
  ...
  /**
   * Works around a minor issue with TreeGrid and program initiated GridEditing
   * in which the selection is lost if the user clicks in the active EditField.
   */
    ...
    if (cancelEditHandler == null) {
      cancelEditHandler = new CancelEditHandler<FileModel>() {
        ...
        public void onCancelEdit(CancelEditEvent<FileModel> event) {
          /*
           * Works around a minor issue with GridInlineEditing in which any
