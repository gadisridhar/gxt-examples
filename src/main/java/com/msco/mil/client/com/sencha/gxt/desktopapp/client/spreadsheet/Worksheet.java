...
import com.msco.mil.client.com.sencha.gxt.desktopapp.client.spreadsheet.Evaluator.Location;
import com.msco.mil.client.com.sencha.gxt.desktopapp.client.spreadsheet.Evaluator.Operation;
...
public class Worksheet implements TableValueProvider {
  ...
  public String getValue(int rowIndex, int columnIndex) {
    ...
    return columnConfig.getValueProvider().getValue(row).toString();
  }
