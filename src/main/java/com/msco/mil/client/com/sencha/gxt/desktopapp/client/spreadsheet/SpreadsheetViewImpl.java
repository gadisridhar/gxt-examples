 ...
 */
package com.msco.mil.client.com.sencha.gxt.desktopapp.client.spreadsheet;
...
import com.msco.mil.client.com.sencha.gxt.desktop.client.widget.AutoVerticalLayoutContainer;
...
public class SpreadsheetViewImpl implements SpreadsheetView, HideHandler, ShowHandler, ColumnProvider {
  ...
  private IdentityValueProvider<Row> getIdentityValueProvider() {
    if (identityValueProvider == null) {
      identityValueProvider = new IdentityValueProvider<Row>();
    }
    return identityValueProvider;
  }

  private RowNumberer<Row> getRowNumberer() {
    if (rowNumberer == null) {
      rowNumberer = new RowNumberer<Row>(getIdentityValueProvider());
    }
    return rowNumberer;
  }
