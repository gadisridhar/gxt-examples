 ...
 */
package com.msco.mil.client.com.sencha.gxt.desktop.client.widget;
...
import com.msco.mil.client.com.sencha.gxt.desktop.client.layout.CascadeDesktopLayout;
import com.msco.mil.client.com.sencha.gxt.desktop.client.layout.CenterDesktopLayout;
import com.msco.mil.client.com.sencha.gxt.desktop.client.layout.DesktopLayout;
import com.msco.mil.client.com.sencha.gxt.desktop.client.layout.DesktopLayout.RequestType;
import com.msco.mil.client.com.sencha.gxt.desktop.client.layout.DesktopLayoutType;
import com.msco.mil.client.com.sencha.gxt.desktop.client.layout.TileDesktopLayout;
...
public class Desktop implements IsWidget {
  ...
  /**
   * Activates a widget by wrapping it in a window if it is not already a
   * window, adding it to the desktop if it's not already on the desktop,
   * restoring it from a minimized state if it's minimized or bringing it to the
  ...
  /**
   * Sets the type of layout manager to use when new windows are added to the
   * desktop, or the desktop size changes.
   * 
